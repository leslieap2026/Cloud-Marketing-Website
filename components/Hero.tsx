...
export default function Hero() {
  return (
    <section className="relative overflow-hidden pb-20 pt-[72px] bg-[radial-gradient(1200px_600px_at_80%_-10%,rgba(124,77,255,0.12),transparent_60%),radial-gradient(900px_500px_at_0%_0%,rgba(34,211,238,0.10),transparent_55%)]">
      <div className="container-x grid items-center gap-14 max-[900px]:grid-cols-1 min-[901px]:grid-cols-[1.1fr_0.9fr]">
        ...
        <div className="relative min-h-[340px] max-[900px]:order-1" aria-hidden="true">
          <div className="absolute -top-8 right-2.5 h-[220px] w-[220px] rounded-full opacity-50 blur-lg bg-[radial-gradient(circle_at_30%_30%,#4f6bff,transparent_70%)]" />
